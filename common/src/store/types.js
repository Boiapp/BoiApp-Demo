...
export const UPDATE_GPS_HEADING = "UPDATE_GPS_HEADING";
...
export const CONFIRM_DELIVERY_BY_DRIVER = "CONFIRM_DELIVERY_BY_DRIVER";
export const CONFIRM_DELIVERY_BY_DRIVER_SUCCESS =
  "CONFIRM_DELIVERY_BY_DRIVER_SUCCESS";
export const CONFIRM_DELIVERY_BY_DRIVER_FAILED =
  "CONFIRM_DELIVERY_BY_DRIVER_FAILED";
export const CONFIRM_DELIVERY_BY_APP = "CONFIRM_DELIVERY_BY_APP";
export const CONFIRM_DELIVERY_BY_APP_SUCCESS =
  "CONFIRM_DELIVERY_BY_APP_SUCCESS";
export const CONFIRM_DELIVERY_BY_APP_FAILED = "CONFIRM_DELIVERY_BY_APP_FAILED";
export const CONFIRM_DELIVERY_BY_PASSENGER = "CONFIRM_DELIVERY_BY_PASSENGER";
export const CONFIRM_DELIVERY_BY_PASSENGER_SUCCESS =
  "CONFIRM_DELIVERY_BY_PASSENGER_SUCCESS";
export const CONFIRM_DELIVERY_BY_PASSENGER_FAILED =
  "CONFIRM_DELIVERY_BY_PASSENGER_FAILED";
export const CREATE_NEW_POT = "CREATE_NEW_POT";
export const CREATE_NEW_POT_SUCCESS = "CREATE_NEW_POT_SUCCESS";
export const CREATE_NEW_POT_FAILED = "CREATE_NEW_POT_FAILED";
export const PAYMENT_POT = "PAYMENT_POT";
export const PAYMENT_POT_SUCCESS = "PAYMENT_POT_SUCCESS";
export const PAYMENT_POT_FAILED = "PAYMENT_POT_FAILED";
export const START_RIDE_BY_DRIVER = "START_RIDE_BY_DRIVER";
export const START_RIDE_BY_DRIVER_SUCCESS = "START_RIDE_BY_DRIVER_SUCCESS";
export const START_RIDE_BY_DRIVER_FAILED = "START_RIDE_BY_DRIVER_FAILED";
