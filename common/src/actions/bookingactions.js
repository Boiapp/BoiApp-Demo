...
export const addBooking = (bookingData) => (dispatch) => async (firebase) => {
  ...
  var data = {
    ...
    customer_token: bookingData.userDetails.profile.pushToken
      ...
      : " ",
    customer_image: bookingData.userDetails.profile.profileImage
      ? bookingData.userDetails.profile.profileImage
      : "",
    drop: drop,
    pickup: pickUp,
    ...
    addressContract: bookingData.addressContract,
