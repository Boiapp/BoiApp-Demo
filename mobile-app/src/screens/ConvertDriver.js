...
export default function ConvertDriver(props) {
  ...
  return (
    <View style={styles.mainView} className="bg-white">
      <Header
        ...
        >
          ...
          <View style={styles.form}>
            <View style={styles.containerStyle}>
              ...
              >
                <Text style={styles.headerTextStyle}>{t("model")}</Text>
                <Input
                  editable={true}
                  returnKeyType={"next"}
                  ...
                  className="bg-[#dde3e2] rounded-full max-w-[90%] mx-auto px-5 py-2 h-10"
                />
              </View>
              <View
                style={[
              ...
              >
                ...
                <Text style={styles.headerTextStyle}>{t("vehicle_model")}</Text>
                <Input
                  editable={true}
                  underlineColorAndroid={colors.TRANSPARENT}
              ...
              >
                <Text style={styles.headerTextStyle}>{t("other")}</Text>
                <Input
                  editable={true}
                  underlineColorAndroid={colors.TRANSPARENT}
