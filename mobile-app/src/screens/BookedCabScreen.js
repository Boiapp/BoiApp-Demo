        ...
        (role == "driver" &&
          ...
          <View style={{ flex: 1 }}>
            <Button
              ...
              buttonStyle={{ height: "100%", backgroundColor: colors.PINK }}
      ...
      >
        ...
        >
          ...
          >
            ...
            <View>
              <Text
                style={{ color: colors.BLACK, fontSize: 16, marginTop: 12 }}
              >
  ...
  return (
    <View style={styles.mainContainer}>
      <Header
        ...
        centerComponent={
          <Text style={styles.headerTitleStyle}>{t("booked_cab_title")}</Text>
        }
        ...
        <View style={styles.topLeftContainer}>
          ...
          <View style={styles.ballandsquare}>
            <View style={styles.hbox1}>
              <View style={styles.hbox1_1} className="mx-auto my-auto" />
            </View>
            <View style={styles.hbox2} />
            <View style={styles.hbox3}>
              <View style={styles.hbox3_1} className="mx-auto my-auto" />
            </View>
          </View>
        </View>
        ...
        {curBooking ? (
          ...
          >
            ...
            <MapMarker
              ...
              image={require("../../assets/images/icons8-map-pin-66.png")}
            />
            <MapMarker
              coordinate={{
                latitude: curBooking.drop.lat,
              ...
              image={require("../../assets/images/icons8-map-pin-66-pinck.png")}
            />
