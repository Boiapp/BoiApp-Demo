...
export default function SignUpWallet(props) {
    ...
    return (
        <ImageBackground source={require('../../../assets/images/background02.png')} style={{
            flex: 1,
            ...
            <SafeAreaView style={styles.container}>
                <Text className='text-center text-white text-4xl' style={{ fontWeight: '700' }}>Welcome to BOI</Text>
                <Text className='text-center text-white text-lg'>Travel and pay with cryptocurrencies</Text>
                <Image
